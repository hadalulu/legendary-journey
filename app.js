...
const pages = [
  ...
  { images: [asset('6122E77E-2D77-4CCA-98B9-09248F9C21B0'), asset('90F4B904-7CA9-4468-8112-81A25E72DDDE')], text: ['El hada Lulú voló hasta la colina donde estaban Emma y Raquel. Allí, Raquel había atrapado con sus enredaderas al gran grupo de duendes que estaba esperando a los cuatro ladrones. Poco después, llegaron también los cuatro duendes y quedaron atrapados como los demás.', '—¡Lo logramos! —dijo Lulú, enseñando el saco de polvo de hada.', '—¡Y el bosque está a salvo! —añadió Emma.', 'Pero Lulú se quedó pensativa.', '—Ahora que conocen el camino al castillo… ¿qué podemos hacer para que no vuelvan?'] },
